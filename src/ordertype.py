...
class OrderTypes:
    ...
    buy_market: ClassVar[OrderType] = OrderType(base_type="BUY", name="Buy Market", mt5_type=mt5.ORDER_TYPE_BUY)

    sell_limit: ClassVar[OrderType] = OrderType(base_type="SELL", name="Sell Limit", mt5_type=mt5.ORDER_TYPE_SELL_LIMIT)
    sell_market: ClassVar[OrderType] = OrderType(base_type="SELL", name="Sell Market", mt5_type=mt5.ORDER_TYPE_SELL)
